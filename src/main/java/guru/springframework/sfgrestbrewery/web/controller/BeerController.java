...
public class BeerController {
    ...
    public ResponseEntity<Mono<BeerDto>> getBeerById(@PathVariable("beerId") UUID beerId,
        ...
        return ResponseEntity.ok(Mono.just(beerService.getById(beerId, showInventoryOnHand))); //ok method takes the body -> this is one option to return the response body
    }
